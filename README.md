...
6. To learn more about Kwallet check the [Kwallet.md](Kwallet.md) file.
---
...
6.  For more git commands check its file [Git_basic.md](Git_basic.md).
...
6.  To get the general idea about this package manager check [Pacman_Syu_guide.md](pacman_syu_guide.md).
---
...
5.  Diagrams written as `mermaid code blocks`
6.  To learn more about the `Markdowm file` then check the file [Markdown_Basic.md](Markdown_Basic.md).
---
...
5.  To learn about the JSON file check the [JSON.md](JSON.md) file.
...
7.  And for the `code` to `UI` workflow explanation check [Work_flow.md](https://github.com/Dharanesh192/Learning-something/blob/main/Flutter_code_to_UI.md) file. 
---
